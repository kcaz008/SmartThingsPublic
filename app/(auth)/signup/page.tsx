    ...
    <section className="w-full max-w-2xl rounded-3xl bg-white p-8 shadow-2xl">
      <div className="mb-8">
        ...
        <p className="mt-3 text-sm leading-6 text-slate-600">
          Signup creates a Supabase Auth user, a business tenant, and an owner
          role. Autopilot starts off by default.
        </p>
      </div>
      ...
      <form action={signupAction} className="grid gap-4 md:grid-cols-2">
        ...
        <label className="block md:col-span-2">
          ...
          <span className="mt-2 block text-xs text-slate-500">
            Use at least 10 characters. Password hashing and storage are handled
            by Supabase Auth.
          </span>
        </label>
        <label className="block">
        ...
        <label className="block">
          <span className="text-sm font-bold text-slate-800">Service area</span>
          <input
            name="serviceArea"
            required
            placeholder="St. Louis County, St. Charles County"
            className="mt-2 w-full rounded-2xl border border-slate-200 px-4 py-3 text-sm outline-none focus:border-blue-300 focus:ring-4 focus:ring-blue-100"
          />
        </label>
        <label className="block">
        ...
        <label className="block">
          <span className="text-sm font-bold text-slate-800">Website</span>
          <input
            name="website"
            type="url"
            className="mt-2 w-full rounded-2xl border border-slate-200 px-4 py-3 text-sm outline-none focus:border-blue-300 focus:ring-4 focus:ring-blue-100"
        ...
        <button
          type="submit"
          className="md:col-span-2 rounded-2xl bg-signal-blue px-5 py-3 text-sm font-bold text-white shadow-lg shadow-blue-500/20 transition hover:bg-blue-700"
        >
          Create account
        </button>
      </form>
